                ...
                <div className='card'>
                    <div className='img-card'>
                        <div className='img-card-box'>
                            <img src={`http://image.tmdb.org/t/p/w185//${this.props.movies.poster_path}`} alt='poster' />
                        </div>
                    </div>
                    ...
                    <div className='desc-movie'>
                        <div className='rating-container'>
                            <div className='rating'>
                                <span className='font-20'>{this.props.movies.vote_average}</span><span className='font-15 secondary-text-color'>/10</span>
                            </div>
                            <div className='fav'>
                        ...
                        <div className='mg-top-10'>
                            <a href='#' className='font-20 primary-text-color mg-r-10'>{this.props.movies.name}</a>
